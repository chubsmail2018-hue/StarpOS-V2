...
title starpOS AI Automation Engine v4.0 

:: -------------------------------------------------------------------------------
:: IMMEDIATE STARTUP VOICE GREETING (Fixed to Speak Perfectly)
:: -------------------------------------------------------------------------------
cls
echo [ SYSTEM ] Initializing default Windows Speech Synthesizer... 

:: Safe nested quote structure ensuring Windows speaks without error strings
...
speech.Speak('System voice module online. Welcome to starpOS... Ready for your instructions.')" 
...
:: -------------------------------------------------------------------------------
:: CHOICE 1: SYSTEM VOICE STATUS BROADCAST
:: -------------------------------------------------------------------------------
:speak_now
cls
echo Windows Voice Broadcast: "All core parameters are running normally..."
powershell -Command "Add-Type -AssemblyName System.Speech; 
𝑠𝑝𝑒𝑒𝑐ℎ
...
speech.Speak('All core parameters are running normally... Storage integrity check passed... starpOS is fully operational.')"
pause
goto aimenu 

:: -------------------------------------------------------------------------------
:: CHOICE 2: RUN 50 TASKS WITH INLINE PAUSES AND STEADY SPEECH
:: -------------------------------------------------------------------------------
:run_50_tasks
cls
color 0A
...
speech.Speak('Initiating fifty structural tasks... Processing sequence live.')" 
...
:: The speech synthesizer now naturally pauses right here between tasks
powershell -Command "Add-Type -AssemblyName System.Speech; 

speech=New−ObjectSystem.Speech.Synthesis.SpeechSynthesizer;s p e e c h equals cap N e w minus cap O b j e c t cap S y s t e m point cap S p e e c h point cap S y n t h e s i s point cap S p e e c h cap S y n t h e s i z e r ;
𝑠𝑝𝑒𝑒𝑐ℎ=𝑁𝑒𝑤−𝑂𝑏𝑗𝑒𝑐𝑡𝑆𝑦𝑠𝑡𝑒𝑚.𝑆𝑝𝑒𝑒𝑐ℎ.𝑆𝑦𝑛𝑡ℎ𝑒𝑠𝑖𝑠.𝑆𝑝𝑒𝑒𝑐ℎ𝑆𝑦𝑛𝑡ℎ𝑒𝑠𝑖𝑧𝑒𝑟;
speech.Speak('Task %%I completed.')"

:: Timed pause to prevent the voice loop from overlapping or cutting off
timeout /t 1 >nul
...
speech.Speak('All fifty operations completed successfully... Systems are stable.')"
pause
goto aimenu